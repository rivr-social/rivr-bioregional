...
const COMMANDS: CommandDefinition[] = [
  ...
  // ---- Regional ----
  {
    id: "basins",
    label: "Basins",
    description: "Browse bioregional basins.",
    path: "/basins",
    group: "Regional",
    icon: Mountain,
    aliases: ["basins", "watersheds", "bioregions", "/basins"],
  },
  {
    id: "locales",
    label: "Locales",
    description: "Browse locales in this region.",
    path: "/locales",
    group: "Regional",
    icon: MapPin,
    aliases: ["locales", "places", "communities", "/locales"],
  },
  {
    id: "families",
    label: "Families",
    description: "Browse families in this region.",
    path: "/families",
    group: "Regional",
    icon: Users,
    aliases: ["families", "/families"],
  },
  {
    id: "groups",
    label: "Groups",
    description: "Browse groups in this region.",
    path: "/groups",
    group: "Regional",
    icon: Users,
    aliases: ["groups", "organizations", "orgs", "/groups"],
  },
  {
    id: "people",
    label: "People",
    description: "Browse people in this region.",
    path: "/people",
    group: "Regional",
    icon: User,
    aliases: ["people", "members", "users", "/people"],
  },
  {
    id: "explore",
    label: "Explore",
    description: "Explore the bioregional network.",
    path: "/explore",
    group: "Regional",
    icon: Globe,
    aliases: ["explore", "discover", "browse", "/explore"],
  },
...
const COMMAND_GROUP_ORDER = ["Regional", "Create", "Navigate", "Explore"] as const;
...
export function CommandBar({
  ...
  // - "Cmd/Ctrl+K" toggles the command dialog.
  ...
  const contextualCommands = useCallback((): CommandDefinition[] => {
    ...
    if (/^\/basins\/[^/]+$/.test(pathname)) {
      commands.push({
        id: "basin-details",
        label: "Basin Details",
        description: "View details for the current basin.",
        path: pathname,
        group: "Current Page",
        icon: Mountain,
        aliases: ["basin details", "this basin"],
      });
    }
    ...
    if (/^\/locales\/[^/]+$/.test(pathname)) {
      commands.push({
        ...
        description: "View details for the current locale.",
        path: pathname,
        group: "Current Page",
        icon: MapPin,
        aliases: ["locale details", "this locale"],
      });
    }
