...
/**
 * Visual locale picker that displays basins and their locales as cards.
 *
 * Provides an alternative to the SearchableSelect dropdown for selecting
 * a home locale in the settings form.
 */
          ...
          return (
            ...
            >
              <CardContent
                className="py-2 px-3"
                onClick={() =>
                  setExpandedBasin(isExpanded ? null : basin.id)
                }
              >
