...
export type Group = {
   ...
   * hrefs become plain anchors (no cross-origin RSC prefetch).
   */
  homeHref?: string
  description: string
  image: string
...
export type Ring = {
  id: string
  name: string
  /** Canonical link target — see `Group.homeHref`. Stamped by `agentToRing`. */
  homeHref?: string
  description: string
  image: string
  memberCount: number
...
export type Family = {
  id: string
  name: string
  /** Canonical link target — see `Group.homeHref`. Stamped by `agentToFamily`. */
  homeHref?: string
  description: string
  image: string
  memberCount: number
