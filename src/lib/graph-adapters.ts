...
export function agentToGroup(agent: SerializedAgent): Group {
  ...
  // orgs like RegenHub whose groupType is "community", or Spirit which has none
  // at all — fall back to the agent's own type so orgs render as orgs instead
  // of silently defaulting to Basic (E4/F1).
