/**
 * API developer-docs index for the sovereign region instance.
 *
...
export const metadata: Metadata = {
  title: "API reference",
  description: "Auth models, federation protocol, and the MCP/REST surface for building against this sovereign RIVR region instance.",
};
  ...
  return (
    <div>
      ...
      <p className="mb-6 max-w-2xl leading-7 text-foreground/85">
        Build against this sovereign region instance over REST, the Model Context Protocol (MCP), and the
