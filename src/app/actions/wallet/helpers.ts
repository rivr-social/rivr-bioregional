 ...
 * invisible to sovereign-homed members/admins viewing via SSO (a federated
 * remote-viewer carries no local NextAuth JWT).
 */
 ...
 * FK violations (2026-07-11 payment-rail sweep). `ensureLocalActorAgent`
