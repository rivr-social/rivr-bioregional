...
export async function POST(request: NextRequest) {
  ...
  // intents. Unified session so federated remote-viewer members pass the gate;
  // the delegated wallet action resolves + projects the principal itself
  // (`getCurrentUserIdForWrite`), so this route only needs the check.
