...
interface FamilyDocsContentProps {
  familyId: string
  documents: Document[]
  initialDocId: string | null
}

export function FamilyDocsContent({ familyId, documents, initialDocId }: FamilyDocsContentProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      >
        <ChevronLeft className="h-4 w-4 mr-2" /> Back to Family
      </Button>
