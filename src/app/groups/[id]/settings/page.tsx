...
export default function GroupSettingsPage(props: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    ...
    async function loadSettings() {
      ...
      // Hydrate the Map Marker tab location (A5).
   ...
   * same metadata-patch shape the former Edit-Profile modal produced (A4).
   */
